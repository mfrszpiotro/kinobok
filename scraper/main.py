    ...
    for fw_movie in scraped_movies:
        ...
        try:
            ...
            try:
                ...
                print(f"⚠️ Could not resolve Letterboxd URI for '{en_title}' ({slug}): {e}")
                continue
            ...
            movies_data.append({
                "id": movie_id,
                "title": en_title,
                "poster": f"https://image.tmdb.org/t/p/w500{tmdb_movie['poster_path']}" if tmdb_movie.get('poster_path') else None,
                "boxd_uri": boxd_uri
            })
